            ...
            <aside className=" p-4 w-64 text-lg flex flex-col items-start justify-start overflow-clip">
                ...
                <nav className="w-full">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <a href="/StudentCourses" className="hover:text-[#5E469C] hover:bg-[#211a3718] block py-2 px-4 border-l-[0.2rem] border-transparent hover:border-[#A773DE] font-medium rounded-md transition-all duration-150 ease-in-out">
                            Courses
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/StudentGpa" className="hover:text-[#5E469C] hover:bg-[#211a3718] block py-2 px-4 border-l-[0.2rem] border-transparent hover:border-[#A773DE] font-medium rounded-md transition-all duration-150 ease-in-out">
                            Gpa
                            </a>
                        </li>

                        <li>
                            <a href="/StudentProfile" className="hover:text-[#5E469C] hover:bg-[#211a3718] block py-2 px-4 border-l-[0.2rem] border-transparent hover:border-[#A773DE] font-medium rounded-md transition-all duration-150 ease-in-out">
                            My detail
                            </a>
                        </li>
