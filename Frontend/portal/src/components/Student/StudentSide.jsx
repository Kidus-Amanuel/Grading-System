...
<aside className=" p-4 w-64 text-lg flex flex-col items-start justify-start overflow-clip">
    ...
    <nav className="w-full text-white">
        <ul className="space-y-2">
            <li>
                <a href="/StudentGpa" className="hover:text-[#ded5f5] hover:bg-[#4f6f8f] block py-2 px-4 border-l-[0.2rem] border-transparent hover:border-[#b09cc6] font-medium rounded-md transition-all duration-150 ease-in-out">
                Gpa
                </a>
                <div> <hr className=' w-65% '/></div>
            </li>
            <li>
                <a href="/CourseEnrollment" className="hover:text-[#ded5f5] hover:bg-[#4f6f8f] block py-2 px-4 border-l-[0.2rem] border-transparent hover:border-[#b09cc6] font-medium rounded-md transition-all duration-150 ease-in-out">
                Courses
                </a>
            ...
            <li>
                <a href="/StudentProfile" className="hover:text-[#ded5f5] hover:bg-[#4f6f8f] block py-2 px-4 border-l-[0.2rem] border-transparent hover:border-[#b09cc6] font-medium rounded-md transition-all duration-150 ease-in-out">
                My detail
                </a>
                <div> <hr className=' w-70% '/></div>
